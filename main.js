        ...
        data: [
            {
                ...
                dataPoints: [
                    ...
                    { label: "Potencia Geral", y: T4 },
                    { label: "Potencia Parte 2", y: T5 },
                    { label: "Radicição Parte 1", y: T6 },
                    { label: "Radicição Parte 2", y: T7 },
                    { label: "Operação basica Geral", y: T8 },
                    { label: "Operação Básica Enem", y: T9 },
                    { label: "Multiplos Gerais", y: T10 },
                    { label: "Multiplos Enem", y: T11 },
                    { label: "Função Quadratica", y: T12 },
                    { label: "Função Exponencial", y: T13 },
                    { label: "Função Garitmica", y: T14 },
                    { label: "Prisma", y: T15 },
                    { label: "Piramide", y: T16 },
                    { label: "Esfera", y: T17 },
                    { label: "Cone", y: T18 },
                    { label: "Cilindro", y: T19 },
                    { label: "Pontos Notaveis", y: T20 },
                    { label: "Relação Metricas", y: T21 },
                    { label: "Segmentos Proporcionais", y: T22 },
                    { label: "Semelhanças", y: T23 },
                    { label: "Estatistica", y: T24 },
                    { label: "Medias", y: T25 },
                    { label: "Análise Combinatorias", y: T26 },
                    { label: "Conjuntos Númericos", y: T27 },
                    { label: "Retas", y: T28 },
                    { label: "Circunferencia", y: T29 },
                    { label: "Razão Trigonometrica", y: T30 },
                    { label: "Lei de Seno e Cosseno", y: T31 },
                    { label: "Progressão Aritmética", y: T32 },
                    { label: "Progressão Geométrica", y: T33 }
                ]
            }
        ]
    };
